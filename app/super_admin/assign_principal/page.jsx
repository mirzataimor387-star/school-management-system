...
export default function AssignPrincipalPage() {
    ...
    const loadData = async () => {
        const c = await fetch("/api/super_admin/campus/list").then(r => r.json());
        const p = await fetch("/api/super_admin/principal/list").then(r => r.json());
    ...
    const assignPrincipal = async () => {
        ...
        const res = await fetch("/api/super_admin/principal/assign", {
            method: "POST",
